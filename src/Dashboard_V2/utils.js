export function getTimestampByRangeTab(type) {
  ...
  switch (type) {
    case 'today':
      ...
      endTime = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 23, 59, 59, 999);
      break;
    ...
    case 'month':
      const monthStartDate = new Date(today.getFullYear(), today.getMonth() - 1, today.getDate());
      startTime = new Date(
    ...
    default:
      throw new Error('Invalid date range type. Supported values are: today, week, month.');
  }
